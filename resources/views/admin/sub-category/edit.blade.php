                        ...
                        <form method="post">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input name="name" value="{{ old('name', $sub_category->name) }}" type="text" class="form-control" id="forName" placeholder="Enter Name" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="slug" value="{{ old('slug', $sub_category->slug) }}" type="text" class="form-control" id="forSlug" placeholder="Slug Ex. URL" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="meta_title" value="{{ old('meta_title', $sub_category->meta_title) }}" type="text" class="form-control" id="forMetaTitle" placeholder="Enter meta title">
                                    <div class="text-danger">{{ $errors->first('meta_title') }}</div>
                                </div>
                                <div class="form-group">
                                    <label for="forMetaDescription">Meta Description</label>
                                    <textarea name="meta_description" type="text" class="form-control" id="forMetaDescription" placeholder="Enter meta description" style="height: 150px;">{{ old('meta_description', $sub_category->meta_description) }}</textarea>
                                    <div class="text-danger">{{ $errors->first('meta_description') }}</div>
                                </div>
                                <div class="form-group">
                                    <label for="forMetaKeywords">Meta Keywords</label>
                                    <input name="meta_keywords" value="{{ old('meta_keywords', $sub_category->meta_keywords) }}" type="text" class="form-control" id="forMetaKeywords" placeholder="Enter Keywords">
