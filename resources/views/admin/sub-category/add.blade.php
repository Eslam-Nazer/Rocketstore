                        ...
                        <form method="post">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input name="name" value="{{ old('name') }}" type="text" class="form-control" id="forName" placeholder="Enter Name" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="meta_title" value="{{ old('meta_title') }}" type="text" class="form-control" id="forMetaTitle" placeholder="Enter meta title">
                                    <div class="text-danger">{{ $errors->first('meta_title') }}</div>
                                </div>
                                <div class="form-group">
                                    <label for="forMetaDescription">Meta Description</label>
                                    <textarea name="meta_description" type="text" class="form-control" id="forMetaDescription" placeholder="Enter meta description" style="height: 150px;">{{ old('meta_description') }}</textarea>
                                    <div class="text-danger">{{ $errors->first('meta_description') }}</div>
                                </div>
                                <div class="form-group">
                                    <label for="forMetaKeywords">Meta Keywords</label>
                                    <input name="meta_keywords" value="{{ old('meta_keywords') }}" type="text" class="form-control" id="forMetaKeywords" placeholder="Enter Keywords">
