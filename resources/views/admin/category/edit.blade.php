                        ...
                        <form method="post">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input name="name" value="{{ old('name', $category->name) }}" type="text" class="form-control" id="forName" placeholder="Enter Name" required>
                                    <div class="text-danger">{{ $errors->first('name') }}</div>
                                </div>
                                <div class="form-group">
                                    <label for="forSlug">Slug <span class="text-danger">*</span></label>
                                    <input name="slug" value="{{ old('slug', $category->slug) }}" type="text" class="form-control" id="forSlug" placeholder="Slug Ex. URL" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="meta_title" value="{{ old('meta_title', $category->meta_title) }}" type="text" class="form-control" id="forMetaTitle" placeholder="Enter meta title">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="meta_keywords" value="{{ old('meta_keywords', $category->meta_keywords) }}" type="text" class="form-control" id="forMetaKeywords" placeholder="Enter Keywords">
